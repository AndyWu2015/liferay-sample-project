...
package com.liferay.foo.service.base;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.foo.service.impl.FooLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.foo.service.impl.FooLocalServiceImpl
 * @see com.liferay.foo.service.FooLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class FooLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.foo.service.FooLocalServiceUtil} to access the foo local service.
	 */
		...
		exportActionableDynamicQuery.setAddCriteriaMethod(new ActionableDynamicQuery.AddCriteriaMethod() {
				...
				public void addCriteria(DynamicQuery dynamicQuery) {
					...
					if (portletDataContext.isInitialPublication()) {
						...
						StagedModelDataHandler<?> stagedModelDataHandler = StagedModelDataHandlerRegistryUtil.getStagedModelDataHandler(Foo.class.getName());
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.foo.model.Foo",
			fooLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.foo.model.Foo");
	}
